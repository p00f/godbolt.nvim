local fun = vim.fn
local api = vim.api
local config = {languages = {cpp = {compiler = "g131", options = {}}, c = {compiler = "cg1131", options = {}}, rust = {compiler = "r1700", options = {}}}, quickfix = {auto_open = false, enable = false}, url = "https://godbolt.org"}
