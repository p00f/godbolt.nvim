local fun = vim.fn
local api = vim.api
local config = {languages = {cpp = {compiler = "g121", options = {}}, c = {compiler = "cg121", options = {}}, rust = {compiler = "r1600", options = {}}}, quickfix = {enable = false, auto_open = false}, url = "https://godbolt.org"}
