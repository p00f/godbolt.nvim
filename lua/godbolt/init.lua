local fun = vim.fn
local api = vim.api
local config = {languages = {cpp = {compiler = "g122", options = {}}, c = {compiler = "cg122", options = {}}, rust = {compiler = "r1640", options = {}}}, quickfix = {enable = false, auto_open = false}, url = "https://godbolt.org"}
